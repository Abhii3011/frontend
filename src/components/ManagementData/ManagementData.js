...
async function fetchGodownData() {
  try {
    const response = await fetch('https://smartinventory-backend-production.up.railway.app/godowncontrollerapi/godowns');
    console.info(response)
    const data = await response.json();
    console.info(data)
    return data;
...
async function fetchReportData() {
  try {
    const response = await fetch('https://smartinventory-backend-production.up.railway.app/reports');
    console.info(response)
    const data = await response.json();
    console.info(data)
    return data;
...
export {fetchReturnData}
  ...
  async function fetchDeliveryItemData() {
    try {
      const response = await fetch('https://smartinventory-backend-production.up.railway.app/outwardItems');
      console.info(response)
      const data = await response.json();
      return data;
    } catch (error) {
